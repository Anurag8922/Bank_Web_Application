...
public class ApplyAtmDAO
{
	public BeanClass applyAtm(HttpServletRequest req,HttpServletResponse res)
    {
       ...
       try
       {
         ...
         ("select * from BankMainTable where AccountNo=? and Password=? and Name=? and AadhaarNo=?");
      ...
      ("insert into BankATMcardDetails(AccountNo,Name,ATMcardNo,ExpiryDate,CVV) values(?,?,?,?,?)");
