		  ...
		  if(ipc.invalidPasswordChecking(req,res))
	      {
			  ...
			  if(new ChakingCardDAO().chakingCard(req,res))
			  {
				   ...
				   {	
					   ...
					   pw.println("<h1><strong style='color:#ff0f0f;'>Invalid Login Process</str"+
					                                                                    "ong></h1>");
				   ...
				   else
				   {
					   ...
					   req.setAttribute("Message","<h1><strong style='color:#ff0f0f;'>ATM Card "+
					                         "Generated Successfull Your Details Are</strong></h1>");
			  ...
			  {			  
				   pw.println("<h1><strong style='color:#ff0f0f;'>You Have One Active Card</str"+
			                                                                            "ong></h1>");
