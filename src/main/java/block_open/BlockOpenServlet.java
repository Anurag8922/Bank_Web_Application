  ...
  { 
	  ...
	  else
	  {
		   ...
		   if(new ChackBlockDAO().chackBlock(req,res))
		   {
				...
				if(mailId==null)
				{
					  pw.println("<h1><strong style='color:#ff0f0f;'>Invalid Details Process</str"+
                                                                                       "ong></h1>");
				...
				{   
				      ...
				      String message="Your OPT from Bank Of India is "+OTP+
				    		                                   " enter it to unlock your account.";
		   ...
		   {			  
				pw.println("<h1><strong style='color:#ff0f0f;'>You Account has Not Blocked</str"+
			                                                                           "ong></h1>");
