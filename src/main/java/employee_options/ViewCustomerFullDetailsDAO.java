...
public class ViewCustomerFullDetailsDAO
{
	public BeanClass viewCustomerFullDetails(HttpServletRequest req,HttpServletResponse res)
    {
       BeanClass bc=null;
       try
       {
    	   ...
    	   PreparedStatement ps=con.prepareStatement
    			                      ("select * from BankMainTable where AccountNo=?");
