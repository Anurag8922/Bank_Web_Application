		  ...
		  if(ipc.invalidPasswordChecking(req,res))
	      {
			  ...
			  if(!(new ChakingCardDAO().chakingCard(req,res)))
			  {
				   ...
				   {	
					   ...
					   pw.println("<h1><strong style='color:#ff0f0f;'>Invalid Login Process</stro"+
					                                                                     "ng></h1>");
			  ...
			  {			  
				   pw.println("<h1><strong style='color:#ff0f0f;'>Card Not Generated Frist Apply "+
			                                                            "To ATM Card</strong></h1>");
