	  ...
	  else
	  {
		  ...
		  if(ipc.invalidPasswordChecking(req,res))
	      {
			  ...
			  if(currentBalance==-2) 
			  {
				  ...
				  pw.println("<h1><strong style='color:#ff0f0f;'>Invalid AccountNo Or Password"+
				                                                                  "</strong></h1>");
			  ...
			  else if(currentBalance==-1)
			  {
				  ...
				  hs.invalidate();
				  pw.println("<h1><strong style='color:#ff0f0f;'>Insufficent Funds...</strong>"+
			                                                                               "</h1>");
			  ...
			  else 
			  {
				  ...
				  pw.println("<h1><strong style='color:#ff0f0f;'>Account Balance="+currentBalance+
						                                                           "</strong></h1>");
				  RequestDispatcher rd=req.getRequestDispatcher("Main.html");
				  rd.include(req,res);
			  }			  
