                                                                                          ...
                                                                                          IOException
  {
	 ...
	 else
	 {
				         ...
				         req.getParameter("newpassword").equals(req.getParameter("confirmpassword")))
		 {
			 ...
			 pw.println("<h1><strong style='color:#ff0f0f;'>Password Change Process Successfull</s"+
			                                                                          "trong></h1>");
		 ...
		 {
			 pw.println("<h1><strong>Invalid OTP Or New Password And Confirm Password Not Matched"+
		                                                                           "</strong></h1>");
