...
public class NewAccountServlet extends HttpServlet
{
                                                                                          ...
                                                                                          IOException
  {
	  ...
	  else
	  {
		   ...
		   bc.setPhoto(new FileInputStream("C://Users//anura//Desktop//Anurag_All//photo//"
		                                                                +req.getParameter("photo")));
		   int k=new NewAccountDAO().newAccount(bc);
		   if(k>0)
		   {
			    String message="Account Created Successfull Your Account No Is This <strong>"
		             +accountNo+"</strong> Please Note It Down It Will Be Required For Operating "+
			    		                                                              "The Account.";
