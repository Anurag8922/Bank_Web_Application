...
public class NewAccountDAO
{
	   public int newAccount(BeanClass bc)
       {
            ...
            try
            {
              ...
              ("insert into BankMainTable (AccountNo,Name,Password,FatherName,AadhaarNo,DateOfBirth"+
    	          ",ContactNo,EmailId,Gender,Occupation,AccountType,Nominee,Address,Photo,AccountB"
            		                           +"alance) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
